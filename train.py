...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolov5s.yaml', help='model.yaml path')    #添加CBAM或者CA模块之前
    # parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolov5_cbam.yaml', help='model.yaml path')    # 添加CBAM模块之后
    parser.add_argument('--data', type=str, default=ROOT / 'data/data1.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default=ROOT / 'runs1/train', help='save to project/name')
